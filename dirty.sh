...
export CROSS_COMPILE="$TOOLCHAIN_DIR/aarch-linux-android-4.9/bin/aarch64-linux-android-"
export ARCH=arm64
...
ZIP_MOVE="${HOME}/dirtycore1"
ZIMAGE_DIR="${HOME}/dirtycore1/arch/arm64/boot"
